...
local furnitures = {
	...
	["toilet"] = {
		...
		nodebox = {
			...
			{ -0.2, -0.2, 0.2, 0.2, 0.1, 0.33 }, -- conector 1-2
...
ts_furniture.register_furniture("default:steelblock", "Steel")
ts_furniture.register_furniture("default:stone", "Stone")
ts_furniture.register_furniture("default:cobble", "Cobblestone")
ts_furniture.register_furniture("default:sandstone", "Sandstone")
ts_furniture.register_furniture("default:obsidian", "Obsidian")
ts_furniture.register_furniture("default:desert_cobble", "Desert Cobblestone")
ts_furniture.register_furniture("default:desert_sandstone", "Desert Sandstone")
ts_furniture.register_furniture("default:clay", "Clay")
